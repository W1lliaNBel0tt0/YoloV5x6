...
def custom(path='path/to/model.pt', channels=12 ,autoshape=True, verbose=True, device=None):
...
def yolov5s(pretrained=True, channels=6, classes=80, autoshape=True, verbose=True, device=None):
...
def yolov5l6(pretrained=True, channels=10, classes=80, autoshape=True, verbose=True, device=None):
    # YOLOv5-large-P6 model https://github.com/ultralytics/yolov5
    return _create('yolov5l6', pretrained, channels, classes, autoshape, verbose, device)


def yolov5x6(pretrained=True, channels=1, classes=80, autoshape=True, verbose=True, device=None):
    # YOLOv5-xlarge-P6 model https://github.com/ultralytics/yolov5
    return _create('yolov5x6', pretrained, channels, classes, autoshape, verbose, device)


if __name__ == '__main__':
    model = _create(name='yolov5n6', pretrained=True, channels=80, classes=320, autoshape=True, verbose=True)  # pretrained
    ...
    results = model(imgs, size=10)  # batched inference
    results.print()
    results.save()
