...
Usage:
    $ python path/to/train.py --data yolov5x6.yaml --weights yolov5s.pt --img 1920  # from pretrained (RECOMMENDED)
    $ python path/to/train.py --data yolov5x6.yaml --weights '' --cfg yolov5s.yaml --img 1920  # from scratch
"""
